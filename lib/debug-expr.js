...
function prop(enabled, obj, prop) {
    return v(enabled, "", prop, obj[prop]);
}


function name(enabled, obj) {
...
D.prop = prop.bind(this, true);
D.name = name.bind(this, true);
D.mb.prop = prop.bind(this, false);
D.mb.name = name.bind(this, false);
